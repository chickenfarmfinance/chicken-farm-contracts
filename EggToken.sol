...
contract EggToken is ERC20Detailed("EGG Token", "EGG", 18), ERC20Mintable, ERC20Burnable, Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (EGG Farmer).
